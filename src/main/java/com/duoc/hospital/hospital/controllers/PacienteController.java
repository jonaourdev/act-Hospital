...
public class PacienteController {
    ...
    @PostMapping
    public ResponseEntity<Paciente> createPaciente(@Valid @RequestBody PacienteCreacionDTO paciente) {
        return ResponseEntity
    ...
    public ResponseEntity<List<AtencionViewPacienteDTO>> getAtencionesById(@PathVariable Long id){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(pacienteService.findAtencionesById(id));
